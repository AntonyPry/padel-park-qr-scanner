...
export const ACCOUNT_ROLES: Array<{
...
}> = [
  {
    ...
    label: 'Владелец',
    description:
      'Полный доступ: настройки клуба, сотрудники, финансы, мотивация и SaaS-управление.',
  },
  {
    value: 'manager',
    label: 'Менеджер',
    description:
      'Операционное управление: гости, смены, сотрудники, загрузка и ежедневные показатели.',
  },
  {
    value: 'admin',
    label: 'Администратор',
