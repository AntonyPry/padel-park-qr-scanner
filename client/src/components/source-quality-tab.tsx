...
export function SourceQualityTab({ canCreateBase = false, onCreateSegment }: {
  ...
  return <div className="w-full min-w-0 space-y-4">
    <div className="flex w-full min-w-0 flex-col gap-3 rounded-xl border bg-card/60 p-3 sm:flex-row sm:items-end sm:justify-between">
