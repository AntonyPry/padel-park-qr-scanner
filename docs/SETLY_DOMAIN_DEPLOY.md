...
it serves the generated `/assets/` bundle, the exact light/dark brand marks
`/brand/setly-mark-black.png` and `/brand/setly-mark-white.png`, plus only
`/favicon.ico`, `/setly-mark.png`, `/favicon-32x32.png`,
`/favicon-16x16.png` and `/apple-touch-icon.png` at the root. It does not expose other root files,
