...
router.post('/clients/views', viewClients, clientsController.createSavedView);
router.put('/clients/views/:viewId', viewClients, clientsController.updateSavedView);
router.delete('/clients/views/:viewId', viewClients, clientsController.deleteSavedView);
