...
const rawEndpointContracts: EndpointContract[] = [
  ...
  { id: 'installationProvisioning.recoveryAccounts', method: 'get', path: '/installation/provisioning/organizations/{organizationId}/clubs/{clubId}/recovery/accounts', rateLimited: true, summary: 'List active club accounts eligible for recovery', tags: ['Installation Recovery'] },
  { id: 'installationProvisioning.recoveryAccount', method: 'get', path: '/installation/provisioning/organizations/{organizationId}/clubs/{clubId}/recovery/accounts/{accountId}', rateLimited: true, summary: 'Read one account for recovery', tags: ['Installation Recovery'] },
  ...
  { id: 'installationProvisioning.recoveryRequests', method: 'get', path: '/installation/provisioning/organizations/{organizationId}/clubs/{clubId}/recovery/requests', rateLimited: true, summary: 'List recovery requests', tags: ['Installation Recovery'] },
