...
const rawEndpointContracts: EndpointContract[] = [
  ...
  { id: 'installationProvisioning.recoveryRequests', method: 'get', path: '/installation/provisioning/organizations/{organizationId}/clubs/{clubId}/recovery/requests', params: apiSchemas.installationProvisioning.recoveryScopeParams, response: apiSchemas.installationProvisioning.recoveryRequestsResponse, rateLimited: true, summary: 'List recovery requests', tags: ['Installation Recovery'] },
