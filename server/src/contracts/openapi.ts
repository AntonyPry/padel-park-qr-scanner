...
const endpointContracts: EndpointContract[] = [
  ...
  { id: 'corporateClients.deposit', method: 'post', path: '/corporate-clients/{id}/deposits', body: apiSchemas.corporateClients.depositBody, params: apiSchemas.corporateClients.withId.params, successStatus: 201, summary: 'Create or link corporate deposit', tags: ['Corporate Clients'] },
