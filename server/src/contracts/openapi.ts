...
const rawEndpointContracts: EndpointContract[] = [
  ...
  { ...apiSchemas.auth.twoFactorLogin, id: 'auth.twoFactorLogin', method: 'post', path: '/auth/login/two-factor', public: true, rateLimited: true, summary: 'Complete account login with two-factor authentication', tags: ['Auth'] },
  ...
  { id: 'auth.twoFactorStatus', method: 'get', path: '/auth/me/two-factor', response: apiSchemas.auth.twoFactorStatusResponse, summary: 'Read current account two-factor authentication status', tags: ['Auth Security'] },
  { id: 'auth.twoFactorEnrollment', method: 'post', path: '/auth/me/two-factor/enrollment', response: apiSchemas.auth.twoFactorEnrollmentResponse, summary: 'Start current account two-factor authentication enrollment', tags: ['Auth Security'] },
  { ...apiSchemas.auth.twoFactorCode, id: 'auth.twoFactorEnrollmentConfirm', method: 'post', path: '/auth/me/two-factor/enrollment/confirm', rateLimited: true, response: apiSchemas.auth.twoFactorRecoveryCodesResponse, summary: 'Confirm current account two-factor authentication enrollment', tags: ['Auth Security'] },
  { ...apiSchemas.auth.twoFactorCode, id: 'auth.twoFactorStepUp', method: 'post', path: '/auth/me/two-factor/step-up', rateLimited: true, response: apiSchemas.auth.twoFactorStepUpResponse, summary: 'Refresh current account recent two-factor confirmation', tags: ['Auth Security'] },
  { id: 'auth.twoFactorRecoveryCodes', method: 'post', path: '/auth/me/two-factor/recovery-codes', rateLimited: true, response: apiSchemas.auth.twoFactorRecoveryCodesResponse, summary: 'Regenerate current account one-time recovery codes', tags: ['Auth Security'] },
  { id: 'auth.twoFactorDisable', method: 'post', path: '/auth/me/two-factor/disable', rateLimited: true, response: apiSchemas.auth.twoFactorDisableResponse, summary: 'Disable current account two-factor authentication', tags: ['Auth Security'] },
  { ...apiSchemas.auth.recoveryStatus, id: 'auth.recoveryStatus', method: 'post', path: '/auth/recovery/status', public: true, rateLimited: true, summary: 'Check recovery link availability without revealing identity', tags: ['Auth Recovery'] },
  { ...apiSchemas.auth.recoveryReset, id: 'auth.recoveryReset', method: 'post', path: '/auth/recovery/reset', public: true, rateLimited: true, summary: 'Set a password with a one-time recovery link', tags: ['Auth Recovery'] },
  ...
  { ...apiSchemas.installationProvisioning.twoFactorLogin, id: 'installationProvisioning.twoFactorSession', method: 'post', path: '/installation/provisioning/session/two-factor', public: true, rateLimited: true, summary: 'Complete installation operator login with two-factor authentication', tags: ['Installation Provisioning'] },
  ...
  { id: 'installationProvisioning.twoFactorStatus', method: 'get', path: '/installation/provisioning/two-factor', response: apiSchemas.installationProvisioning.operatorTwoFactorStatusResponse, summary: 'Read installation operator two-factor authentication status', tags: ['Installation Security'] },
  { id: 'installationProvisioning.twoFactorEnrollment', method: 'post', path: '/installation/provisioning/two-factor/enrollment', response: apiSchemas.installationProvisioning.twoFactorEnrollmentResponse, summary: 'Start installation operator two-factor authentication enrollment', tags: ['Installation Security'] },
  { ...apiSchemas.installationProvisioning.twoFactorCode, id: 'installationProvisioning.twoFactorEnrollmentConfirm', method: 'post', path: '/installation/provisioning/two-factor/enrollment/confirm', rateLimited: true, response: apiSchemas.installationProvisioning.twoFactorRecoveryCodesResponse, summary: 'Confirm installation operator two-factor authentication enrollment', tags: ['Installation Security'] },
  { ...apiSchemas.installationProvisioning.twoFactorCode, id: 'installationProvisioning.twoFactorStepUp', method: 'post', path: '/installation/provisioning/two-factor/step-up', rateLimited: true, response: apiSchemas.installationProvisioning.twoFactorStepUpResponse, summary: 'Refresh installation operator recent two-factor confirmation', tags: ['Installation Security'] },
  { id: 'installationProvisioning.twoFactorRecoveryCodes', method: 'post', path: '/installation/provisioning/two-factor/recovery-codes', rateLimited: true, response: apiSchemas.installationProvisioning.twoFactorRecoveryCodesResponse, summary: 'Regenerate installation operator one-time recovery codes', tags: ['Installation Security'] },
  ...
  { id: 'installationProvisioning.recoveryAccounts', method: 'get', path: '/installation/provisioning/organizations/{organizationId}/clubs/{clubId}/recovery/accounts', params: apiSchemas.installationProvisioning.recoveryScopeParams, response: apiSchemas.installationProvisioning.recoveryAccountsResponse, rateLimited: true, summary: 'List active club accounts eligible for recovery', tags: ['Installation Recovery'] },
  { id: 'installationProvisioning.recoveryAccount', method: 'get', path: '/installation/provisioning/organizations/{organizationId}/clubs/{clubId}/recovery/accounts/{accountId}', params: apiSchemas.installationProvisioning.recoveryAccountParams, response: apiSchemas.installationProvisioning.recoveryAccountResponse, rateLimited: true, summary: 'Read one account for recovery', tags: ['Installation Recovery'] },
  { ...apiSchemas.installationProvisioning.recoveryProfile, id: 'installationProvisioning.recoveryProfile', method: 'put', path: '/installation/provisioning/organizations/{organizationId}/clubs/{clubId}/recovery/accounts/{accountId}', rateLimited: true, summary: 'Update allowed account profile fields', tags: ['Installation Recovery'] },
  { id: 'installationProvisioning.recoveryRequests', method: 'get', path: '/installation/provisioning/organizations/{organizationId}/clubs/{clubId}/recovery/requests', params: apiSchemas.installationProvisioning.recoveryScopeParams, query: apiSchemas.installationProvisioning.recoveryRequestsQuery, response: apiSchemas.installationProvisioning.recoveryRequestsResponse, rateLimited: true, summary: 'List recovery requests', tags: ['Installation Recovery'] },
  { ...apiSchemas.installationProvisioning.recoveryRequest, id: 'installationProvisioning.recoveryRequestCreate', method: 'post', path: '/installation/provisioning/organizations/{organizationId}/clubs/{clubId}/recovery/requests', rateLimited: true, summary: 'Create a password reset request', tags: ['Installation Recovery'] },
  { ...apiSchemas.installationProvisioning.recoveryIssue, id: 'installationProvisioning.recoveryIssue', method: 'post', path: '/installation/provisioning/organizations/{organizationId}/clubs/{clubId}/recovery/requests/{requestId}/issue', rateLimited: true, summary: 'Issue a one-time password reset link', tags: ['Installation Recovery'] },
  { ...apiSchemas.installationProvisioning.recoveryRevoke, id: 'installationProvisioning.recoveryRevoke', method: 'post', path: '/installation/provisioning/organizations/{organizationId}/clubs/{clubId}/recovery/requests/{requestId}/revoke', rateLimited: true, summary: 'Revoke a password reset request', tags: ['Installation Recovery'] },
  { body: apiSchemas.installationProvisioning.emptyBody, params: apiSchemas.installationProvisioning.recoveryAccountParams, response: apiSchemas.installationProvisioning.twoFactorResetResponse, id: 'installationProvisioning.ownerTwoFactorReset', method: 'post', path: '/installation/provisioning/organizations/{organizationId}/clubs/{clubId}/recovery/accounts/{accountId}/two-factor/reset', rateLimited: true, summary: 'Reset exact-club owner two-factor authentication as installation operator', tags: ['Installation Recovery', 'Installation Security'] },
  { body: apiSchemas.accounts.recoveryRequest, params: apiSchemas.accounts.params, response: apiSchemas.accounts.recoveryRequestResponse, id: 'accounts.recoveryCreate', method: 'post', path: '/accounts/{id}/recovery', rateLimited: true, successStatus: 201, summary: 'Create an owner-scoped employee recovery request', tags: ['Accounts', 'Auth Recovery'] },
  { query: apiSchemas.accounts.recoveryQuery, params: apiSchemas.accounts.params, rateLimited: true, id: 'accounts.recoveryList', method: 'get', path: '/accounts/{id}/recovery', summary: 'List owner-scoped recovery requests for one employee', tags: ['Accounts', 'Auth Recovery'] },
  { body: apiSchemas.accounts.recoveryAction, params: apiSchemas.accounts.recoveryRequestParams, response: apiSchemas.accounts.recoveryIssueResponse, rateLimited: true, id: 'accounts.recoveryIssue', method: 'post', path: '/accounts/recovery/{requestId}/issue', summary: 'Issue an owner-scoped one-time reset link', tags: ['Accounts', 'Auth Recovery'] },
  { body: apiSchemas.accounts.recoveryAction, params: apiSchemas.accounts.recoveryRequestParams, response: apiSchemas.accounts.recoveryRevokeResponse, rateLimited: true, id: 'accounts.recoveryRevoke', method: 'post', path: '/accounts/recovery/{requestId}/revoke', summary: 'Revoke an owner-scoped reset request', tags: ['Accounts', 'Auth Recovery'] },
  { body: apiSchemas.accounts.twoFactorReset, params: apiSchemas.accounts.params, response: apiSchemas.auth.twoFactorResetResponse, rateLimited: true, id: 'accounts.twoFactorReset', method: 'post', path: '/accounts/{id}/two-factor/reset', summary: 'Reset an employee two-factor authentication factor as the same-club owner', tags: ['Accounts', 'Auth Security'] },
  ...
  { id: 'accounts.update', method: 'put', path: '/accounts/{id}', body: apiSchemas.accounts.body.partial(), params: apiSchemas.accounts.params, summary: 'Update system user', tags: ['Accounts'] },
