    ...
    blocks: [
      {
        ...
        type: 'step',
        text:
          'Открой «Касса текущей смены». Если смена еще не начата, сначала начни смену по обычному процессу, затем вернись в этот раздел.',
      },
      {
        screenshotIndex: 2,
    ...
    screenshots: [
      {
        ...
        caption:
          'Раздел кассы текущей смены показывает верхние метрики, стартовый остаток и расходы.',
      },
      {
        src: '/onboarding/shift-cash/full-cash-metrics.png',
        alt: 'Касса активной смены с верхними метриками',
        caption:
          'На экране видно состояние кассы смены перед фиксацией стартового остатка.',
      },
      {
    ...
    blocks: [
      {
        ...
        type: 'step',
        text:
          'Открой «Касса текущей смены» и перейди к форме «Добавить расход из кассы». Если начальный остаток еще не зафиксирован, сначала заполни его.',
      },
      {
        screenshotIndex: 2,
      ...
      },
      {
        ...
        type: 'step',
        text:
          'После сохранения расход должен появиться в списке расходов смены, у строки должны быть сумма, связанный Finance ID, описание и прикрепленное фото чека. Сумма расходов должна увеличиться, а ожидаемый остаток наличности уменьшиться.',
      },
    ],
    screenshots: [
      {
        ...
        caption:
          'Раздел кассы текущей смены перед добавлением расхода: метрики, стартовый остаток и форма расхода.',
      },
      {
        src: '/onboarding/shift-cash/full-cash-metrics.png',
        alt: 'Касса активной смены перед добавлением расхода',
      ...
      },
      {
        ...
        caption:
          'В карточке расхода видны Finance ID, сумма, описание и превью чека.',
      },
    ],
  }),
  'manager.shift-cash.reconciliation-review': makeTextLesson({
    ...
    blocks: [
      {
        ...
        type: 'step',
        text:
          'Открой «Касса текущей смены». Проверь, что работаешь с нужной активной сменой и видишь верхние метрики: на начало, наличная выручка, расходы, ожидаемый остаток и факт.',
      },
      {
    ...
    screenshots: [
      ...
      },
      {
        ...
        caption:
          'Сохраненный расход показывает Finance ID, сумму, описание и прикрепленный чек.',
      },
      {
  ...
  'owner.shift-cash.control-review': makeTextLesson({
    ...
    blocks: [
      {
        ...
        type: 'step',
        text:
          'Открой «Касса текущей смены». Владелец может проходить обучение за роли, но права владельца при этом сохраняются.',
      },
      {
        screenshotIndices: [2, 3],
    ...
    screenshots: [
      ...
      },
      {
        ...
        caption:
          'Карточка расхода связывает Finance ID, сумму, описание и фото чека.',
      },
      {
        src: '/onboarding/shift-cash/close-dialog-variance-comment.png',
