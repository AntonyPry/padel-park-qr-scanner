...
const CRM_KNOWLEDGE_SECTIONS = [
  ...
  },
  {
    ...
    cards: [
      {
        title: 'Что показывает раздел',
        text:
          'В «Настройках смены» вкладка «Правила мотивации» показывает базовые правила, бонусные правила, условия начисления, категории, проценты, пороги и периоды действия.',
      },
      {
    ...
    managerLens:
      'Менеджер открывает «Настройки смены», чтобы проверить правила мотивации и понять, какие условия участвуют в расчетах сотрудников.',
    ownerLens:
      'В «Настройках смены» владелец в CRM проверяет базовые ставки, правила переработки, бонусные правила, категории, пороги и периоды действия. Экран показывает, какие правила сейчас участвуют в расчете начислений.',
  },
  {
    slug: 'utilization',
