        ...
        tasks: [
          ...
          },
          {
            ...
            lesson: {
              ...
              summary:
                'Инструкция показывает, как открыть форму клиента, заполнить обязательный минимум и проверить сохраненную карточку.',
              blocks: [
                {
                  screenshotIndex: 0,
        ...
        tasks: [
          {
            ...
            lesson: {
              ...
              summary:
                'Инструкция показывает, как открыть расписание, заполнить телефонную бронь и проверить, что она появилась без конфликта.',
              blocks: [
                {
                  screenshotIndex: 0,
                ...
                },
                {
                  ...
                  type: 'step',
                  text:
                    'В форме заполни данные, которые нужны смене для встречи клиента и контроля оплаты. Источник должен показывать, что бронь создана по телефону.',
                  items: [
                ...
                },
                {
                  ...
                  type: 'step',
                  text:
                    'После сохранения посмотри на сетку и список броней дня. Бронь должна стоять в правильном времени и корте, не пересекаться с соседними слотами и иметь понятный статус оплаты.',
                  items: [
...
const roleInstructionLessons = {
  ...
  'admin.subscription.redemption-review': {
    ...
    summary:
      'Инструкция показывает, как открыть карточку клиента, оформить списание абонемента и проверить остаток с историей.',
    blocks: [
      {
        screenshotIndex: 0,
      ...
      : [
          {
            ...
            caption: `Так выглядит раздел «${section.title}». Открой его перед чтением инструкции.`,
          },
        ];
  const cards = [
    ...section.cards,
