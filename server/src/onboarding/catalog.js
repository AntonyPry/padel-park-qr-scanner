    ...
    screenshots: [
      {
        ...
        caption:
          '1 - верхние метрики кассы, 2 - зафиксированный стартовый остаток, 3 - форма расхода.',
      },
      {
        src: '/onboarding/shift-cash/full-cash-metrics.png',
        alt: 'Касса активной смены с верхними метриками',
        caption:
          '1 - верхние метрики кассы, 2 - стартовый остаток, 3 - блок расходов смены.',
      },
      {
        src: '/onboarding/shift-cash/opening-form.png',
        alt: 'Форма фиксации остатка на начало смены',
        caption:
          '1 - поля купюр и мелочи, 2 - комментарий по пересчету, 3 - кнопка «Зафиксировать остаток».',
      },
      {
        src: '/onboarding/shift-cash/opening-saved.png',
        alt: 'Сохраненный остаток на начало смены',
        caption:
          '1 - сохраненные суммы, 2 - кто и когда зафиксировал остаток и комментарий.',
      },
    ],
  }),
    ...
    screenshots: [
      {
        ...
        caption:
          '1 - верхние метрики кассы, 2 - стартовый остаток, 3 - форма расхода.',
      },
      {
        src: '/onboarding/shift-cash/full-cash-metrics.png',
        alt: 'Касса активной смены перед добавлением расхода',
        caption:
          '1 - метрики, 2 - стартовый остаток, 3 - где находится форма расхода.',
      },
      {
        src: '/onboarding/shift-cash/expense-form.png',
        alt: 'Форма добавления расхода из кассы',
        caption:
          '1 - сумма и категория, 2 - описание, 3 - фото чека, 4 - кнопка «Добавить расход».',
      },
      {
    ...
    screenshots: [
      {
        ...
        caption:
          '1 - метрики кассы, 2 - стартовый остаток, 3 - зона расходов.',
      },
      {
        src: '/onboarding/shift-cash/full-cash-metrics.png',
        alt: 'Полные метрики кассы активной смены',
        caption:
          '1 - на начало, выручка, расходы и ожидаемый остаток, 2 - зафиксированный старт, 3 - расходы.',
      },
      {
        src: '/onboarding/shift-cash/opening-saved.png',
        alt: 'Зафиксированный стартовый остаток смены',
        caption:
          '1 - сохраненные купюры и мелочь, 2 - сотрудник, время и комментарий фиксации.',
      },
      {
        src: '/onboarding/shift-cash/expense-result-attached.png',
      ...
      },
      {
        ...
        caption:
          '1 - ожидаемые суммы, 2 - фактические купюры и мелочь, 3 - расхождение, 4 - обязательный комментарий, 5 - завершение сверки.',
      },
    ],
  }),
    ...
    screenshots: [
      {
        ...
        caption:
          '1 - метрики кассы, 2 - стартовый остаток, 3 - расходы смены.',
      },
      {
        src: '/onboarding/shift-cash/full-cash-metrics.png',
        alt: 'Кассовый блок активной смены для владельца',
      ...
      },
      {
        ...
        caption:
          '1 - ожидаемые суммы, 2 - факт, 3 - расхождение, 4 - обязательный комментарий, 5 - завершение сверки.',
      },
      {
        src: '/onboarding/shift-cash/accountant-linked-row-history.png',
        alt: 'Финансовая история со связанной кассовой операцией',
        caption:
          '1 - дата операции, 2 - действие Finance updated, 3 - причина со ссылкой на кассу смены.',
      },
    ],
  }),
    ...
    screenshots: [
      {
        ...
        caption:
          '1 - период отчета, 2 - экспорт, 3 - структура расходов, 4 - строка расхода в P&L.',
      },
      {
        src: '/onboarding/shift-cash/accountant-period-export.png',
        alt: 'Финансовый отчет бухгалтера с периодом и экспортом',
      ...
      },
      {
        ...
        caption:
          '1 - дата операции, 2 - действие связанной Finance-записи, 3 - причина со ссылкой на кассу смены.',
      },
    ],
  }),
