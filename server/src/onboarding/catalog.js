...
const SHIFT_REPORT_TEMPLATE_SCREENSHOTS = [
  makeShiftReportTemplateScreenshot(
    ...
    'В списке видны карточки шаблонов: название, статус, расписание, описание и времена отчетов. Карточка открывает настройки шаблона.',
  ),
  makeShiftReportTemplateScreenshot(
    'create-modal.png',
    ...
    blocks: [
      {
        ...
        type: 'step',
        text:
          'Открой раздел «Настройки смены» и перейди к шаблонам отчетов. В списке должны быть карточки с названием, статусом, временем отчета, описанием и пунктами.',
        items: [
      ...
      },
      {
        ...
        type: 'paragraph',
        text:
          'Результат корректен, если карточка показывает осмысленные данные шаблона: название, статус, расписание, описание и пункты. В тексте и на карточке не должно быть устаревших полей области действия шаблона.',
      },
    ],
  }),
    ...
    blocks: [
      {
        ...
        type: 'step',
        text:
          'Открой раздел «Настройки смены» и перейди к шаблонам отчетов. Начинай проверку со списка карточек: название, статус, расписание, описание и пункты отчета.',
        items: [
