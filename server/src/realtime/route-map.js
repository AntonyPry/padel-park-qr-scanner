const DEFAULT_DOMAIN_HINTS = {
  ...
  shifts: {
    queryGroups: ['shifts', 'payroll', 'staff', 'motivation'],
    routes: ['/admin/staff', '/admin/motivation', '/admin/finances'],
  },
  staff: {
...
const ROUTE_RULES = [
  ...
  { pattern: /^\/telephony\/calls\/(?<id>\d+)\/(?:start|client|client\/create|complete|ignore|recording-reference)$/, domain: 'telephony', entity: 'telephony_call', action: 'updated' },
